...
export default function Todo() {
    return (
        ...
        <main className="flex min-h-screen justify-center items-center bg-slate-50">
            <div className="bg-slate-300 rounded-3xl py-6 shadow-md h-[400px] w-[450px] flex flex-col text-slate-800">
                ...
                <div className="mx-8 mt-4 mb-6">
                    <form className="flex gap-3 items-center">
                        <input
                            ...
                            className="border border-slate-400 rounded-full flex-1 py-1 px-2 outline-none focus-within:border-slate-100 bg-slate-50 focus-within:bg-slate-100 placeholder:text-slate-300 required"
                        />
                ...
                <ul className="px-6">
                    <li className="flex px-4 py-2 hover:bg-slate-100">
